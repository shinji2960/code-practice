...
/* harmony import */ var _javascripts_my_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../javascripts/my.js */ "./src/javascripts/my.js");
/* harmony import */ var _javascripts_my_js__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_javascripts_my_js__WEBPACK_IMPORTED_MODULE_2__);
...
aos__WEBPACK_IMPORTED_MODULE_3___default.a.init(); // import 'swiper/dist/css/swiper.css';
...
var mySwiper = new Swiper('.swiper-container', {
  ...
  breakpoints: {
    ...
    375: {
      slidesPerView: 1 // loopedSlides: 3,
      // spaceBetween: 30,
...
/* WEBPACK VAR INJECTION */(function($) {// ハンバーガーメニューページ内リンク
$(function () {
  $('#nav-content a').on('click', function (event) {
    $('#nav-input').prop('checked', false);
  });
}); // ハンバーガーメニューページ内リンク end
// accordion

$(function () {
  $('#learning-method dd').hide();

  var tg = function tg(s) {
